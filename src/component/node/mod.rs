// =============================================================================
//! - Node Component for CroftSoft Mars
//!
//! # Metadata
  ...
  fn update(&mut self) {
    ...
    if let Some(event) = event_option {
      ...
      if let Some(event_target) = event_target_option {
        ...
        self.inputs.borrow_mut().node_display_change_requested =
